...
class Gallery extends Component {
    ...
    store = (file) => {
        ...
        let type = checkMediaType(file)
        if( !type ) {
            alert('الرجاء اختيار صورة او فيديو')
            this.unLoad()
        }
